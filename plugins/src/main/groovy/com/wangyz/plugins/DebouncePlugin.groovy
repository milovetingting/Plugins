...
class DebouncePlugin extends Transform implements Plugin<Project> {
    ...
    void transform(TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        ...
        println('-------------------- Plugin transform end --------------------')
        println("Plugin cost $time s")
    }
            ...
            directoryInput.file.eachFileRecurse {
                file ->
                    ...
                    if (isClassFile(name)) {
                        ...
                        ClassVisitor classVisitor = new DebounceClassVisitor(classWriter)
